/**
 * SonarQube VB.Net Plugin
 * Copyright (C) 2015 AE Networks
 * arngani@aetvn.com
 *
...
@Properties({
	  @Property(
	    key = VbNetPlugin.FILE_SUFFIXES_KEY,
	    defaultValue = VbNetPlugin.FILE_SUFFIXES_DEFVALUE,
	    name = "File suffixes",
	    description = "Comma-separated list of suffixes of files to analyze.",
	    project = true, global = true
	  ),
	  @Property(
	    key = VbNetPlugin.IGNORE_HEADER_COMMENTS,
	    defaultValue = "true",
...
public class VbNetPlugin extends SonarPlugin {

	  public static final String LANGUAGE_KEY = "vbnet";
	  public static final String LANGUAGE_NAME = "VB.Net";

	  public static final String FILE_SUFFIXES_KEY = "sonar.vbnet.file.suffixes";
	  public static final String FILE_SUFFIXES_DEFVALUE = ".vb";

	  public static final String VBNET_WAY_PROFILE = "FxCop";

	  public static final String REPOSITORY_KEY = "vbharpsquid";
	  public static final String REPOSITORY_NAME = "SonarQube";

	  public static final String IGNORE_HEADER_COMMENTS = "sonar.vbnet.ignoreHeaderComments";
	  ...
	  public List getExtensions() {
	    ...
	    builder.add(
	      VbNet.class);
	    //builder.addAll(VbNetCodeCoverageProvider.extensions());
